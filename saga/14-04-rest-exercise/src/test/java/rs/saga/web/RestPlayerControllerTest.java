...
public class RestPlayerControllerTest {
    ...
    public void testGetPlayer() throws Exception {
        when(playerService.findByUsername("slave")).thenReturn(PlayerBuilder.getInstance().slave().createPlayer());
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/rest/players/slave"))
                ...
                .andExpect(jsonPath("$.firstName", is("Slavisa")));
    }
    ...
    public void create() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.post("/rest/players/create")
    ...
    public void edit() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.put("/rest/players/edit")
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(slave)))
